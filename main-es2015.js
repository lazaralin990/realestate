...
let LoginComponent = class LoginComponent {
    constructor(storage, router, userService) {
...
let HeaderComponent = class HeaderComponent {
    ...
    */
        Object(firebase__WEBPACK_IMPORTED_MODULE_3__["auth"])().onAuthStateChanged(userData => {
            if (userData && userData.emailVerified) {
                const userData = this.userService.getProfile();
...
let HandleAdsService = class HandleAdsService {
...
HandleAdsService.ctorParameters = () => [
...
let StorageService = class StorageService {
    ...
    getUserFromDatabase(uid) {
        const ref = Object(firebase__WEBPACK_IMPORTED_MODULE_2__["auth"])().currentUser.uid;
        console.log(ref);
        return ref;
    }
    getUserFromDatabase2(uid) {
        const ref2 = Object(firebase__WEBPACK_IMPORTED_MODULE_2__["database"])().ref('users/' + uid);
        return ref2.once('value')
            .then(snapshot => snapshot.val());
    }
    getAgentFromDatabase(uid) {
        const ref3 = Object(firebase__WEBPACK_IMPORTED_MODULE_2__["database"])().ref('agents/' + uid);
        return ref3.once('value')
            .then(snapshot => snapshot.val());
    }
    getOwnerFromDatabase(uid) {
        const ref4 = Object(firebase__WEBPACK_IMPORTED_MODULE_2__["database"])().ref('owners/' + uid);
